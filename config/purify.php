    ...
    */
    ...
    'configs' => [
        'default' => [
            ...
            'HTML.Allowed' => 'h1[class],h2[class],h3[class],h4[class],h5[class],h6[class],b,strong,i[class],em[class],hr[class],s,del,a[href|title|class|style],ul[class],ol[class],li[class],p[class|style],br,span[class],img[style|class|width|height|alt|src],blockquote,div[class]',
