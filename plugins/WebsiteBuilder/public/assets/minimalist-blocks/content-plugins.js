...
<div class="row">
    <div class="column">
        ...
        {
		    'thumbnail': 'preview/plugin-gallery-02.png',
		    'category': '120',
		    'html': `
<div class="row relative sm-items-1">
    <div class="py-6 flex flex-col justify-center column" style="width: 33.2943%; flex: 0 0 auto;">
        <h1 class="leading-none font-medium size-54">flying high</h1>
        <div class="spacer height-20"></div>
        <p class="text-justify italic font-light size-16">By Monica Reed</p>
        <p>Still, the world moves around her like wind through leaves. Before the mirror, she seeks not image but stillness — the quiet before the sky opens. To rise is not to chase the sky, but to release what weighs the heart.</p>
    </div>
    <div class="flex flex-col justify-center items-center column two-third" style="width: 100%;">
        <div data-cb-type="media-grid" data-cb-columns="3" class="grid-sortable" data-cb-gap="16" data-cb-rounded="8" data-cb-content-theme="light">
            <div class="gallery-item"><img src="assets/minimalist-blocks/images/ai-lMoX0.jpg" alt=""></div>
            <div class="gallery-item">
                <img src="assets/minimalist-blocks/images/ai-MILpb.jpg" alt="Sample Title">
...
`	
		...
		/*
        {
		    'thumbnail': 'preview/plugin-more-info.png',
		    'category': '120',
		    'html': `
<span data-cb-type="more-info" class="more-info-trigger style-info" data-cb-content="&lt;strong&gt;Jupiter&lt;/strong&gt;&lt;br&gt;&lt;br&gt;Jupiter is the fifth planet from the Sun and the largest in the Solar System. It's a gas giant with a mass more than 2.5 times that of all other planets combined!&lt;br&gt;&lt;br&gt;🌟 Fun fact: Jupiter has 95 known moons!" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">Jupiter</span>
`	
		},
        */
		{
